...
for(let c=0;c<_results[1].length;c++){ethContract.methods.users(_results[1][c]).call(function(_err,_result){$('#direct_idOfLevel'+level+'_'+Number(c+1)).html(Number(_result.id)+117);$('#direct_idOfLevel'+level+'_'+Number(c+1)).attr("title","Addr:"+_results[1][c])})}
if(level<13)
...
for(let c=0;c<_results[1].length;c++){ethContract.methods.users(_results[1][c]).call(function(_err,_result){$('#multi_idOfLevel'+level+'_1_'+Number(c+1)).html(Number(_result.id)+117);$('#multi_idOfLevel'+level+'_1_'+Number(c+1)).attr("title","Addr:"+_results[1][c])})}
for(let c=0;c<_results[2].length;c++){ethContract.methods.users(_results[2][c]).call(function(_err,_result){$('#multi_idOfLevel'+level+'_2_'+Number(c+1)).html(Number(_result.id)+117);$('#multi_idOfLevel'+level+'_2_'+Number(c+1)).attr("title","Addr:"+_results[2][c])})}
if(level<13)
